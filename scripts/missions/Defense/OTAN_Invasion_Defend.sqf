...
//-------------------- SPAWN HELIDROP
		...
		["DEFENSECircle",1,true,false,2000, "random", true, 150, 100, 10, 0.01, 75,false] execVM "scripts\HeliDrop.sqf";
		["DEFENSECircle",1,true,false,2000, "random", true, 125, 100, 10, 0.01, 75,false] execVM "scripts\HeliDrop.sqf";
		["DEFENSECircle",1,true,false,2000, "random", true, 100, 100, 10, 0.01, 75,false] execVM "scripts\HeliDrop.sqf";
