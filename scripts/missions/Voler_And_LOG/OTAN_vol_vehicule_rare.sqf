...
private ["_flatPos","_accepted","_position","_enemiesArray","_fuzzyPos","_x","_briefing","_completeText","_failedText"];
...
private _missionType = selectRandom[
    ['an Slammer Up', 'B_MBT_01_TUSK_F'],
    ['a Blackfoot', 'B_Heli_Attack_01_dynamicLoadout_F'],
    ['a Marshall', 'B_APC_Wheeled_01_cannon_F'],
    ['a Rhino', 'B_AFV_Wheeled_01_up_cannon_F'],
    ['a GhohstHawk', 'B_Heli_Transport_01_F'],
    ['a MLRS', 'B_T_MBT_01_mlrs_F'],
    ['a Cheetah', 'B_T_APC_Tracked_01_AA_F']
];
...
for "_i" from 0 to _random do 
{
	...
	_spawnGroup = [_nposition, EAST, (configfile >> "CfgGroups" >> "West" >> "BLU_F" >> "Infantry" >> "BUS_InfTeam_AA")] call BIS_fnc_spawnGroup;
