...
//-------------------- FIND POSITION FOR OBJECTIVE
	...
	_officier forceAddUniform "U_O_OfficerUniform_ocamo";
...
private _unittypes = ["O_Soldier_F","O_Soldier_lite_F","O_Soldier_GL_F","O_Soldier_AR_F","O_soldier_M_F","O_Soldier_LAT_F","O_medic_F","O_engineer_F","O_HeavyGunner_F","O_Soldier_TL_F","O_Soldier_AT_F","O_Soldier_AA_F"];
...
private _officierEscortGroup = createGroup EAST;
...
rescuemarkertext = "Enlever l'Officier CSAT";
"rescuemarker" setMarkerText "Enlever l'Officier CSAT";
[west,["EnleverOfficier"],[
"Un Officier importants'est réfugié non loin de cette zone! Notre client souhaite obtenir des informations de cet Officier. Enlever l'Officier CSAT et ramener-le à la base..."
,"Enlever l'Officier CSAT","rescuecircle"],(getMarkerPos "rescuecircle"),"Created",0,true,"search",true] call BIS_fnc_taskCreate;
...
for "_i" from 0 to _random do 
{
	...
	_spawnGroup = [_nposition, EAST, (configfile >> "CfgGroups" >> "East" >> "OPF_F" >> "Infantry" >> "O_InfTeam_AT_Heavy")] call BIS_fnc_spawnGroup;
...
{
	_nposition = [_fuzzyPos,random 50,250, 1, 0, 60 * (pi / 180), 0, []] call BIS_fnc_findSafePos;
	_spawnGroup_squad = [_nposition, EAST, (configfile >> "CfgGroups" >> "East" >> "OPF_F" >> "Infantry" >> "OIA_InfSquad_Weapons")] call BIS_fnc_spawnGroup;
...
{
	_nposition = [_fuzzyPos,random 50,250, 1, 0, 60 * (pi / 180), 0, []] call BIS_fnc_findSafePos;
	_spawnGroup_squad = [_nposition, EAST, (configfile >> "CfgGroups" >> "East" >> "OPF_F" >> "Infantry" >> "OIA_InfTeam_AA")] call BIS_fnc_spawnGroup;
	[_spawnGroup_squad, getpos rescueObj3,50 + random 200] call BIS_fnc_taskPatrol;
	RESCUEunits_squad = RESCUEunits_squad + (units _spawnGroup_squad);
...
{
	_nposition = [_fuzzyPos,random 50,250, 1, 0, 60 * (pi / 180), 0, []] call BIS_fnc_findSafePos;
	_spawnGroup_squad = [_nposition, EAST, (configfile >> "CfgGroups" >> "East" >> "OPF_F" >> "Infantry" >> "OI_reconTeam")] call BIS_fnc_spawnGroup;
	RESCUEunits_squad = RESCUEunits_squad + (units _spawnGroup_squad);
	[_spawnGroup_squad, getpos rescueObj3,50 + random 200] call BIS_fnc_taskPatrol;
	sleep 1;
	{_x addCuratorEditableObjects [units _spawnGroup_squad, false];} forEach allCurators;
...
_infunits = ["O_Soldier_F","O_Soldier_lite_F","O_Soldier_GL_F","O_Soldier_AR_F","O_soldier_M_F","O_Soldier_LAT_F","O_medic_F","O_engineer_F","O_HeavyGunner_F","O_Soldier_TL_F","O_Soldier_AT_F","O_Soldier_AA_F"];
