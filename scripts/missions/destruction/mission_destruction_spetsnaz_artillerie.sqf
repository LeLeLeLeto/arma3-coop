...
groupes append ([_liste_groupes, _nombre_groupes, _position] call MFW_fn_spawnGroups);
groupes append ([_liste_vehicules, _nombre_vehicules, _position] call MFW_fn_spawnVehicles);
groupes append ([_liste_unites, _position, east] call MFW_fn_spawnUnitsInBuildings);
