...
private _missionType = selectRandom[
    ['an Offroad AT', 'I_C_Offroad_02_AT_F'],
    ['an Offroad LMG', 'I_C_Offroad_02_LMG_F'],
    ['an Offroad', 'I_C_Offroad_02_unarmed_brown_F'],
    ['an Offroad 12.7', 'I_G_Offroad_01_armed_F'],
    ['an Offroad AT', 'I_G_Offroad_01_AT_F'],
...
//-------------------- SPAWN BRIEFING
	...
	_briefing = "<t align='center'><t size='2.2'>Nouvelle Mission</t><br/><t size='1.5' color='#00B2EE'>Voler le véhicule</t><br/>____________________<br/>Les Syndicates protègent un véhicule de valeur dans cette zone.<br/>Partez à sa recherche et ramenez-le à voter base pour pouvoir l'utiliser...</t>";
